...
export default function AgentStatusPanel() {
  return (
    <aside className="w-96 border-l bg-white dark:bg-slate-800 dark:border-slate-700 flex flex-col p-4 md:p-6">
                  ...
                  <div className="flex items-center gap-2">
                    {metric.status && (
                      <Badge
                        ...
                        className={`text-xs px-1.5 py-0.5 ${metric.status === "Active" ? "bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300" : "bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300"}`}
                      >
                        {metric.status}
                      </Badge>
                    )}
